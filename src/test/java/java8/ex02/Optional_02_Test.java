...
public class Optional_02_Test {
    ...
    public void test_optional_ifPresent() throws Exception {
        ...
        // utiliser la méthode ifPresent pour vérifier que l'age est bien 30, déclencher l'exception GoodException pour 
        // valider que la fonction en paramètre de ifPresent a bien été exécutée.
        julesOpt.filter(adult).map(p ->p.getAge()).ifPresent(i-> { assert (i == 30); throw new GoodException();});
    }
