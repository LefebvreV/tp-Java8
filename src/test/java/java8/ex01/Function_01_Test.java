...
public class Function_01_Test {
    ...
    // La fonciton compose applique sur le intToPerson avant de l'appliquer sur personToAccount
    ...
    // La fonciton andThen applique sur le personToAccount avant de l'appliquer sur intToPerson
